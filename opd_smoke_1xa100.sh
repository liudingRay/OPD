...
export MAX_RESP_LENGTH=512  # TODO: 31744 /15360 / 7168 / 3072 / 5120
export MAX_VAL_RESP_LENGTH=512 # TODO: 15360 / 7168 / 3072
...
export MINI_BATCH_SIZE=1 # TODO: 1 / 8 / 16 / 32 / 64 (default 64)
...
export IS_PLOT=False # TODO: True / False (default False)
...
export TRAIN_DATASET=datasets/smoke_dapo_4.parquet
...
export TRAIN_DATASET_NAME=smoke_dapo_4
...
# 设置缓存位置
export OPD_CACHE_ROOT=/leonardo_work/EUHPC_D29_082/OPD-experiment/.cache/opd
