...
export ACTOR_ENTROPY_FROM_LOGITS_WITH_CHUNKING=${ACTOR_ENTROPY_FROM_LOGITS_WITH_CHUNKING:-True}
export REWARD_MODEL_MICRO_BATCH_SIZE=${REWARD_MODEL_MICRO_BATCH_SIZE:-8}
export TRAINER_N_GPUS_PER_NODE=${TRAINER_N_GPUS_PER_NODE:-4}
export TRAINER_NNODES=${TRAINER_NNODES:-2}
export TRAINER_SAVE_FREQ=${TRAINER_SAVE_FREQ:-40}
